...
public class AdminForm extends javax.swing.JFrame {
    ...
    private void toggleTextFields(boolean showAll) {
        usernameTF.setVisible(showAll);
        passTF.setVisible(showAll);
        userTypeTF.setVisible(showAll);
        userIDTF.setEditable(showAll); // User ID chỉ cho phép nhập khi không hiển thị tất cả
    }
